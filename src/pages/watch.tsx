...
const Watch = () => {
  ...
  const [source, setSource] = useState("AGG");
  ...
  useEffect(() => {
    toast.info(
      <div>
       cloud: please disable adblock if you would like to support the media hosters
        extension or{" "}
    ...
    toast.info(
      <div>
        Cloud: Thank you for using 321movies we hope you enjoy
  ...
  return (
    <div className={styles.watch}>
      ...
      >
        <option value="AGG">Aggregator : 1 (Best-Server)</option>
        <option value="VID">Aggregator : 2 (Okay-Server)</option>
        <option value="PRO">Aggregator : 3 (HQ-Server)</option>
        <option value="EMB">Aggregator : 4</option>
        <option value="MULTI">Aggregator : 5 (Slow-Server)</option>
        <option value="SUP" defaultChecked>
          Aggregator : 6 (decent-server)
        </option>
      </select>
